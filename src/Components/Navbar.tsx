...
import cloudtop from "../assets/cloudtop.jpeg"
  ...
  return (
    <>
        ...
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={cloudtop} className="h-8" alt="Flowbite Logo" width="100%"/>
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Cloudtop G</span>
        </Link>
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse gap-1">
            <Link to="/signup" type="button" className="text-white bg-[#1998FF] hover:bg-[#1998FF] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</Link>
            <button onClick={handleLogout} type="button" className="text-white bg-[red] hover:bg-[#1998FF] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log out</button>
